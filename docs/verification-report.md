...
**PROJECTED** is calculated from datasheet typicals, not measured. Those get
replaced with real PPK2 measurements at bring-up.
...
- Keep-out per Raytac Ver.K §2.2-2.3: 12.4 × 3.8 mm, all layers, plus the
  ...
  F/In1/In2/B inside the region: **none** (DRC rule areas active throughout
  routing and fills).
