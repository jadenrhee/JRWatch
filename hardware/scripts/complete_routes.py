...
NX = int((X1 - X0) / GRID) + 1
NY = int((Y1 - Y0) / GRID) + 1
CLR = 0.235         # clearance 0.13 + half-track 0.075 + 0.03 quantization
...
def main():
    ...
    # D-025 rework: J2 now at (100,107.75), pad row y=105.9 on F.Cu.
    links = [
        ('3V0',      (91.25, 106.65),  (90.75, 101.75),  0.15, 1, 1),
        ('CC2',      (88.55, 102.45),  (98.25, 109.555), 0.15, 1, 1),
        ('DISP_MOSI',(101.75, 105.90), (95.35, 91.90),   0.15, 0, 1),
        ('DISP_SCK', (102.25, 105.90), (95.35, 93.50),   0.15, 0, 1),
        ('DISP_CS',  (101.25, 105.90), (95.35, 94.30),   0.15, 0, 1),
        ('SHPHLD',   (89.75, 106.65),  (110.90, 95.51),  0.15, 1, 1),
    ]
